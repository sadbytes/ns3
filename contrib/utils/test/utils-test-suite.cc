...
/**
 * \defgroup utils-tests Tests for utils
 * \ingroup utils
 * \ingroup tests
 */
...
UtilsTestSuite::UtilsTestSuite()
    : TestSuite("utils", Type::UNIT)
{
    // Duration for TestCase can be QUICK, EXTENSIVE or TAKES_FOREVER
    AddTestCase(new UtilsTestCase1, TestCase::Duration::QUICK);
}
 ...
 */
static UtilsTestSuite sutilsTestSuite;
